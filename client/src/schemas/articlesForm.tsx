...
export type articlesValues = Yup.InferType<typeof articlesValidationSchema>

export const articlesInitialValues: articlesValues = {
	title: '',
	content: '',
	excerpt: '',
	score: 0,
...
export const articlesValidationSchema = Yup.object({
	title: Yup.string()
